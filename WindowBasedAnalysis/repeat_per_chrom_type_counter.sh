...
do
    #echo "$line" 
    count_DNA=$(grep "$line" /proj/uppstore2017185/b2014034_nobackup/Dasha/RepeatMasker_Vanessa/GCA_905220365.1_ilVanCard2.1_genomic_chroms.fna.out | awk '/DNA/' |  wc -l)
    ...
    echo "$line	$count_DNA	$count_TcM	$count_LINE	$count_SINE	$count_LTR	$count_nonLTR" #	$count_rpt	$length_rpt"
done
