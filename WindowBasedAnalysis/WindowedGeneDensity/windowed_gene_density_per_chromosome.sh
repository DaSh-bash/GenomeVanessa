...
# Fill in the table
echo "chrom begin end count_gene length_gene" # count_SINE length_SINE count_DNA length_DNA count_TcM length_TcM count_LINE length_DNA count_LTR length_LTR count_nonLTR length_nonLTR"
