...
OUT_DIR=/proj/uppstore2017185/b2014034_nobackup/Karin/link_map_vanessa/output/11_MCScanX/input_dir
...
for tmpfile in $(ls);do awk 'NR<6 {print $0}' $tmpfile >> $OUT_DIR/filtered.blast;done
wait
cd ../
rm -r tmp/
