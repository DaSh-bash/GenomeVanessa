rule order_markers:
    ...
    shell:
        """
        zcat {input.datacall} | java -cp LM3 OrderMarkers2 map={input.filt_map} data=- numThreads={threads} {params.dist_method} recombination2=0 chromosome={params.chrom} informativeMask=1 minError=0.1 &> {log.run}.tmp
