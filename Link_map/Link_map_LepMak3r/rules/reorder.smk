rule reorder_markers:
    ...
    shell:
        """
        zcat {input.datacall} | java -cp LM3 OrderMarkers2 map={input.filt_map} data=- numThreads={threads} {params.eval_order} {params.dist_method} informativeMask=1 minError=0.1 recombination2=0 &> {log.run}.tmp
